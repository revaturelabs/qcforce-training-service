...
public class BatchServiceImpl implements BatchService {
	...
	public List<Batch> getBatchesByEmployeeFullName(String firstName, String lastName) {
		return batchRepo.findAllByEmployeeBatchesEmployeeFirstNameAndEmployeeBatchesEmployeeLastName(firstName, lastName);
	}

	@Override
	public List<Batch> getBatchesByLeadTrainerEmployeeId(int employeeId) {
		return batchRepo.findAllByEmployeeBatchesEmployeeEmployeeIdAndEmployeeBatchesEmployeeRole(employeeId, "ROLE_LEAD_TRAINER");
	}

	@Override
	public List<Batch> getBatchesByLeadTrainerName(String firstName, String lastName) {
		return batchRepo.findAllByEmployeeBatchesEmployeeFirstNameAndEmployeeBatchesEmployeeLastNameAndEmployeeBatchesEmployeeRole(firstName, lastName, "ROLE_LEAD_TRAINER");
	}
